...
class UserRepo {
    static async find(){
        ...
        return result.rows //So the actual data that we really care about on that result object is on the rows property. So result dot rows, that's the data we care about. That's going to be the array of objects we get back where each object represents one distinct user.
    }
